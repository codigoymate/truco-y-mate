...
void Application::initColors() {
	...
	init_pair(MENU_BG_PAIR, COLOR_BLACK, COLOR_GREEN);
	init_pair(MENU_BORDER_PAIR, COLOR_WHITE, COLOR_GREEN);

	init_pair(MENUITEM_TEXT_PAIR, COLOR_WHITE, COLOR_GREEN);
	init_pair(MENUITEM_BG_PAIR, COLOR_BLACK, COLOR_GREEN);
	init_pair(MENUITEM_BORDER_PAIR, COLOR_WHITE, COLOR_GREEN);
